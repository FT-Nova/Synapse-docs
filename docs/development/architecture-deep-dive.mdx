...
:::info
This document provides a comprehensive technical deep-dive into SYNAPSE's architecture. For a high-level overview, see [Core Concepts → Architecture](../concepts/architecture.mdx).
:::
